...
ParamIndex ParamDescription[] = {
  ...
  {Requests::HEADER_CHI,			{"chi"}},
  {Requests::HEADER_CHI_END,			{"chi_end"}},
  {Requests::HEADER_CHI_RANGE_AVERAGE,		{"chi_range_average"}},
  {Requests::HEADER_CHI_RANGE_TOTAL,		{"chi_range_total"}},
  {Requests::HEADER_DETECTOR_DISTANCE,		{"detector_distance"}},
  {Requests::HEADER_KAPPA,			{"kappa"}},
  {Requests::HEADER_KAPPA_END,			{"kappa_end"}},
  {Requests::HEADER_KAPPA_RANGE_AVERAGE,	{"kappa_range_average"}},
  {Requests::HEADER_KAPPA_RANGE_TOTAL,		{"kappa_range_total"}},
  {Requests::HEADER_OMEGA,			{"omega"}},
  {Requests::HEADER_OMEGA_END,			{"omega_end"}},
  {Requests::HEADER_OMEGA_RANGE_AVERAGE,	{"omega_range_average"}},
  {Requests::HEADER_OMEGA_RANGE_TOTAL,		{"omega_range_total"}},
  {Requests::HEADER_PHI,			{"phi"}},
  {Requests::HEADER_PHI_END,			{"phi_end"}},
  {Requests::HEADER_PHI_RANGE_AVERAGE,		{"phi_range_average"}},
  {Requests::HEADER_PHI_RANGE_TOTAL,		{"phi_range_total"}},
