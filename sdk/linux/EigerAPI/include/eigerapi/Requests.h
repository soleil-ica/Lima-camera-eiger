...
namespace eigerapi
{
  ...
  public:
    ...
    enum PARAM_NAME {TEMP,
		     ...
		     HEADER_CHI,
		     HEADER_CHI_END,
		     HEADER_CHI_RANGE_AVERAGE,
		     HEADER_CHI_RANGE_TOTAL,
		     HEADER_DETECTOR_DISTANCE,
		     HEADER_KAPPA,
		     HEADER_KAPPA_END,
		     HEADER_KAPPA_RANGE_AVERAGE,
		     HEADER_KAPPA_RANGE_TOTAL,
		     HEADER_OMEGA,
		     HEADER_OMEGA_END,
		     HEADER_OMEGA_RANGE_AVERAGE,
		     HEADER_OMEGA_RANGE_TOTAL,
		     HEADER_PHI,
		     HEADER_PHI_END,
		     HEADER_PHI_RANGE_AVERAGE,
		     HEADER_PHI_RANGE_TOTAL,
		     HEADER_WAVELENGTH,
    };
